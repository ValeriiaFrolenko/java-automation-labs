...
import org.gradle.api.provider.Property; // Імпортуємо новий клас для проперті
import org.gradle.api.tasks.Input;          // Анотація для звичайних текстових вхідних даних
